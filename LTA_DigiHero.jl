...
n_states = 3
sim_no = string("2026_07_20/", n_states, "states/age_sex_comorbidity_covs_fups")
...
println("Iterations limit reached: ", count(estimation_output.iteration_limit_reached), "/", length(estimation_output.iteration_limit_reached))
...
fig1 = LTA.compare_estimation_2_data_fup(estimation_output; T=5, symptom_names=symptoms_list_fup, type="best_fitted", observation_type="bernoulli")
fig1_with_CI = LTA.compare_estimation_2_data_with_CIs_monthly(estimation_output; T=5, symptom_names=symptoms_list_fup, type="best_fitted", observation_type="bernoulli")
